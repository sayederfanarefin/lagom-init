...
import info.sayederfanarefin.hello.hello.api.UserData;
import info.sayederfanarefin.hello.hello.impl.HelloCommand.*;
...
//    }
    ...
    public ServiceCall<NotUsed, String> hello(String id) {
        ...
        //    CompletionStage<UserData> response = externalService.getPosts().invoke();
    ...
    @Override
    public Topic<info.sayederfanarefin.hello.hello.api.HelloEvent> helloEvents() {
        ...
        return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
                ...
                persistentEntityRegistry.eventStream(tag, offset).map(eventAndOffset -> {
                    ...
                    info.sayederfanarefin.hello.hello.api.HelloEvent eventToPublish;
                    ...
                    if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
                        ...
                        eventToPublish = new info.sayederfanarefin.hello.hello.api.HelloEvent.GreetingMessageChanged(
